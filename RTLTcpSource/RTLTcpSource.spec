...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/RTLTcpSource/cpp
%configure
make
popd
...
%{_prefix}/dom/components/%{name}/RTLTcpSource.spd.xml
%{_prefix}/dom/components/%{name}/RTLTcpSource.prf.xml
%{_prefix}/dom/components/%{name}/RTLTcpSource.scd.xml
